...
contract ${contractName} is ERC1155X, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string public name = unicode"${sanitizeString(name)}";
    string public symbol = unicode"${sanitizeString(tokenSymbol)}";
