...
interface OperatorFilterer721Interface extends ethers.utils.Interface {
  functions: {
...
export class OperatorFilterer721 extends BaseContract {
  ...
  interface: OperatorFilterer721Interface;
