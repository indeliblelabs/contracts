...
interface IndelibleSecurityInterface extends ethers.utils.Interface {
  functions: {
...
export class IndelibleSecurity extends BaseContract {
  ...
  interface: IndelibleSecurityInterface;
