    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private TRAIT_INDEX_NAME = ["example1", "example2", "example3", "example4", "example5", "example6", "example7", "example8", "example9"];
        ...
        constructor() ERC721A("EXAMPLENAME", "EXPL") {
...
TIERS[8] = [10,80,100,180,200,210,220,230,240,260,270];
            ...
            returns (string memory)
        {
            ...
            svgBytes.appendSafe('<svg class="style-examplename" width="1200" height="1200" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style>.style-examplename{background-image:url(');
