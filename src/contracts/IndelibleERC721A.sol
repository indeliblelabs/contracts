...
contract IndelibleERC721A is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    uint internal constant DEVELOPER_FEE = 250; // of 10,000 = 2.5%
    uint internal constant MAX_BATCH_MINT = 20;

    uint[] internal primeNumbers;
    uint[][] internal tiers;
